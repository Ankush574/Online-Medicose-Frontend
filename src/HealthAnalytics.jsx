...
const HealthAnalytics = ({ embedded = false }) => {
  ...
  const renderAnalyticsExperience = () => (
    <div className="health-analytics-content">
      <section aria-labelledby="health-analytics-heading">
        <h2 id="health-analytics-heading" tabIndex={0}>Health Analytics</h2>
        ...
        <ul aria-label="Medication Stats" className="medication-stats-list">
  ...
  if (embedded) {
    return renderAnalyticsExperience();
  }

  return (
    <section className="health-analytics-main" role="region" aria-label="Health Analytics Workspace">
      <header className="analytics-hero">
        <div>
          <p className="eyebrow">Analytics Suite</p>
          <h1>Understand your adherence trajectory</h1>
          <p className="subcopy">Track medication, vitals, and proactive insights in one dedicated workspace.</p>
        </div>
        <div className="analytics-actions">
          <button className="ghost-btn">Schedule coaching</button>
          <button className="primary-btn">Sync wearables</button>
        </div>
      </header>
      {renderAnalyticsExperience()}
    </section>
  );
};
